...
const BookingPage = () => {
  ...
  const handleAvailability = async (e) => {
    ...
    try {
      ...
      else if(newTime<doctors.timings[0] || newTime
        >doctors.timings[1])
        {
          message.error("Appointment not available");
          return;
        }
      const res = await axios.post(
  ...
  return (
    <Layout>
      <h3 className="text-center text-2xl md:text-3xl p-4">Book an Appointment</h3>
